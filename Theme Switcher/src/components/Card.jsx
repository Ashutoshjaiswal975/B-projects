...
import useTheme from "../contect/theme";
...
export default function Card() {
  ...
  return (
    <div
      className={`w-full border rounded-lg shadow transition-all ${
        themeMode === "light"
    ...
    >
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <a
            href="/"
            className={`text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all ${
              themeMode === "light"
